...
module.exports = function (_opts) {
  ...
  Object.keys(collection.constructor.prototype).forEach(function (prop) {
    if ('function' === typeof this[prop]) store['_' + prop] = this[prop].bind(collection);
  ...
  store.list = function (options, cb) {
  ...
  store.load = function (id, options, cb) {
    ...
    collection.findOne(entity || { id: id }, options, function (err, entity) {
      if (err) return cb(err);
